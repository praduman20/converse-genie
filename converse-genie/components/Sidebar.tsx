      ...
      <ul className="gap-5 flex lg:flex-col">
        <li className="flex-1">
          <Link
            ...
            rounded-md bg-[#2991EE] hover:opacity-50"
          >
            <BotMessageSquare className="h-6 w-6 lg:h-8 lg:w-8" />
            <div className="hidden md:inline">
              <p className="text-xl">Create</p>
              <p className="text-xm font-extralight">New Chatbot</p>
            </div>
          </Link>
        </li>
        <li>
          ...
          >
            ...
            <div className="hidden md:inline">
              ...
              <p className="text-xm font-extralight">Chatbots</p>
            </div>
          </Link>
        </li>
        <li>
          ...
          >
            ...
            <div className="hidden md:inline">
              ...
              <p className="text-xm font-extralight">Sessions</p>
            </div>
          </Link>
        </li>
      </ul>
